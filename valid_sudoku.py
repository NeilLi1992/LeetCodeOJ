...
class Solution:
    ...
    def isValidSudoku(self, board):
        ...
        for row in board:
            for n in row:
                if n not in valid_numbers or (n is not '.' and row.count(n) > 1):
                    return False
        ...
        for j in range(9):
            ...
            for n in column:
                if n not in valid_numbers or (n is not '.' and column.count(n) > 1):
                    return False
        ...
        for box_index in [(i,j) for i in [0,3,6] for j in [0,3,6]]:
            ...
            for n in box:
                if n not in valid_numbers or (n is not '.' and box.count(n) > 1):
                    return False
