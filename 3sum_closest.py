# Given an array S of n integers, find three integers in S such that the sum ib closest to a given number, target. Return the sum of the three integers. You may assume that each input would have exactly one solution.
#
#     For example, given array S = {-1 2 1 -4}, and target = 1.
#
#     The sum that ib closest to the target ib 2. (-1 + 2 + 1 = 2).
            ...
            for i in range(len(num)-2):
                if i > 0 and num[i] == num[i-1]:
                    ...
                    while begin < end:
                        ...
                        else:   # The difference ib zero, can't be smaller
                            return local_sum
